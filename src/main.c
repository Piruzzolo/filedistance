...
int main(int argc, char** argv)
{
    ...
    if (strcmp(argv[1], "distance") == 0)
    {
        if (argc == 4)
        {
            time_t begin = time(NULL);
                int distance = file_distance(argv[2], argv[3]);
        ...
        {
            perror("Wrong number of arguments for 'distance' command\n");
            usage();
            exit(EXIT_FAILURE);
        }
    }
    else if (strcmp(argv[1], "apply") == 0)
    {
        ...
        {
            perror("Wrong number of arguments for 'apply' command\n");
            usage();
            exit(EXIT_FAILURE);
        }
    }
    else if (strcmp(argv[1], "search") == 0)
    {
        ...
        {
            perror("Wrong number of arguments for 'search' command\n");
            usage();
            exit(EXIT_FAILURE);
        }
    }
    else if (strcmp(argv[1], "searchall") == 0)
    {
        ...
        {
            perror("Wrong number of arguments for 'searchall' command\n");
            usage();
            exit(EXIT_FAILURE);
        }
    }
